 ...
 * Generated at: 2023-08-31 01:48:53 UTC
...
public final class bookSearch_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <select id=\"searchType\" class=\"search-select\">\r\n");
      ...
      out.write("                    <input type=\"text\" id=\"bookSearch\" placeholder=\"검색어를 입력하세요\" class=\"search-input\">\r\n");
      out.write("                    <button id=\"searchButton\" class=\"search-button\">검색</button>\r\n");
      out.write("                    <h3>도서 검색 결과</h3>\r\n");
      out.write("                    <div id=\"bookSearchArea\">\r\n");
      out.write("                        <ul class=\"book-list\">\r\n");
      out.write("                            <!-- 검색 결과가 여기에 동적으로 추가됩니다 -->\r\n");
      out.write("                        </ul>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      ...
      out.write("</body>\r\n");
      out.write("\r\n");
      out.write("<script src=\"https://code.jquery.com/jquery-3.7.0.js\" integrity=\"sha256-JlqSTELeR4TLqP0OG9dxM7yDPqX1ox/HfgiSLBj8+kM=\" crossorigin=\"anonymous\">\r\n");
      out.write("</script>\r\n");
      out.write("<script>\r\n");
      ...
      out.write("                data: {\r\n");
      out.write("                    target: searchType,\r\n");
      out.write("                    query: keyword\r\n");
      out.write("                },\r\n");
      out.write("                headers: {\r\n");
      out.write("                    Authorization: \"KakaoAK 17277a95dd97fdc1056945e7eb59c526\"\r\n");
      out.write("                }\r\n");
      out.write("            })\r\n");
      out.write("            .done(function(msg) {\r\n");
      out.write("                var bookList = msg.documents;\r\n");
      out.write("                var bookListHtml = \"\";\r\n");
      out.write("\r\n");
      out.write("                if (bookList.length === 0) {\r\n");
      out.write("                    bookListHtml = \"<p>검색 결과가 없습니다.</p>\";\r\n");
      out.write("                } else {\r\n");
      out.write("                    bookListHtml += \"<ul class='book-list'>\";\r\n");
      out.write("                    for (var i = 0; i < bookList.length; i++) {\r\n");
      out.write("                        var book = bookList[i];\r\n");
      out.write("                        var isbn = book.isbn;\r\n");
      out.write("                        var extractedIsbn = isbn.slice(-13);\r\n");
      out.write("                        bookListHtml += \"<li>\";\r\n");
      out.write("                        bookListHtml += \"<img src='\" + book.thumbnail + \"' alt='표지 이미지' class='thumbnail'>\";\r\n");
      out.write("                        bookListHtml += \"<div class='book-info'>\";\r\n");
      out.write("                        bookListHtml += \"<h4>\" + book.title + \"</h4>\";\r\n");
      out.write("                        bookListHtml += \"<p><strong>저자:</strong> \" + book.authors + \"</p>\";\r\n");
      out.write("                        bookListHtml += \"<p><strong>출판사:</strong> \" + book.publisher + \"</p>\";\r\n");
      out.write("                        bookListHtml += \"<p><strong>ISBN:</strong> \" + extractedIsbn + \"</p>\";\r\n");
      out.write("                        bookListHtml += \"<p>\" + book.contents + \"...</p>\";\r\n");
      out.write("                        bookListHtml += \"<p><strong>출판일:</strong> \" + book.datetime.split('T')[0] + \"</p>\";\r\n");
      out.write("                        bookListHtml += \"</div>\";\r\n");
      out.write("                        bookListHtml += \"</li>\";\r\n");
      out.write("                    }\r\n");
      out.write("                    bookListHtml += \"</ul>\";\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                $(\"#bookSearchArea\").html(bookListHtml);\r\n");
      out.write("            })\r\n");
